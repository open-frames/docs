...
Open Frames is a powerful tool for creating interactive link previews. Below are some best practices to keep in mind when building Open Frames frames.

## Performance

For the best UX, frames should be fast and snappy. Clients are encouraged to enforce a 5 second timeout, which is something to be aware of as a frame developer.
